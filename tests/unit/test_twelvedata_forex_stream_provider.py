...
from app.providers.twelvedata_forex_stream import (
    ForexCandleBuilder,
    PriceTick,
...
async def test_provider_lazily_connects_reuses_connection_and_cleans_up() -> None:
    ...
    provider = TwelveDataForexStreamProvider(
        lambda _: client,
        queue_capacity=10,
...
def test_forex_candle_builder_bucket_boundaries_and_no_synthetic_gaps() -> None:
    builder = ForexCandleBuilder()
